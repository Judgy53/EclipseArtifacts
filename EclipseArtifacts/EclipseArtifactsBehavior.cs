...
namespace EclipseArtifacts
{
    public static class EclipseArtifactsBehavior
    {
		...
		{
			IL.RoR2.HoldoutZoneController.FixedUpdate += (il) => GetSelectedEclipseHook(il, 2, DifficultyIndex.Eclipse2);
		}
		...
		{
			IL.RoR2.HealthComponent.TakeDamage += (il) => GetSelectedEclipseHook(il, 8, DifficultyIndex.Eclipse8);
		}
